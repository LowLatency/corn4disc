//credit to https://github.com/samirkumardas/opus-to-pcm/blob/master/example/index.html
const EventEmitter = require('events');
module.exports = class Ogg extends EventEmitter {
    constructor(channel) {
    	super();
    ...
    init() {
        ...
        this.oggHeader = this.appendByteArray(this.oggHeader, page);
    ...
    getOGG() {
        ...
        while (this.queue.length) {
            ...
            oggData = this.appendByteArray(oggData, segmentData);
        }
